...
RUN mkdir /usr/lib/jvm; \
    wget "https://github.com/graalvm/oracle-graalvm-ea-builds/releases/download/jdk-24.0.0-ea.28/graalvm-jdk-24.0.0-ea.28_linux-x64_bin.tar.gz"; \
    tar -zxC /usr/lib/jvm -f graalvm-jdk-24.0.0-ea.28_linux-x64_bin.tar.gz; \
    rm -f graalvm-jdk-24.0.0-ea.28_linux-x64_bin.tar.gz
# Configure glibc and GraalVM
ENV JAVA_HOME=/usr/lib/jvm/graalvm-jdk-24+30.1 \
    PATH=/usr/lib/jvm/graalvm-jdk-24+30.1/bin:$PATH
